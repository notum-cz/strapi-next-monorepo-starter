...
Visit the [full documentation](https://notum-cz.github.io/strapi-next-monorepo-starter/docs/architecture) for architecture, setup, and workflow guides.
