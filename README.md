...
- **Rich Text Editors**: Choose between modern [TipTap](https://tiptap.dev/) (recommended) and classic [CKEditor v5](https://ckeditor.com/) - both pre-configured with shared styles and colors. See [Strapi README](./apps/strapi/README.md#rich-text-editors-tiptap-vs-ckeditor) for guidance on choosing the right editor for your project.
...
- `packages/design-system`: shared styles, primarily for sharing rich text editor (TipTap and CKEditor) color configurations
