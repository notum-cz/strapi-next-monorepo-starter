...
The exported Next config is wrapped with `withSentryConfig()` for source-map upload and Sentry build-time integration. See [Sentry](../reference/sentry.md).
