...
`sync-types` is defined as `cp -r ../../apps/strapi/types/generated ./generated`. The `generated/` directory in this package is intended to be a refresh of the Strapi-side files — keep them in sync after any schema change. See [Strapi Types Usage](./strapi-types-usage.md).
...
- [Strapi Types Usage](./strapi-types-usage.md) — practical use of `@repo/strapi-types`
- [Add a Content Type](./add-content-type.md) — when you'll need to regenerate types and sync them
