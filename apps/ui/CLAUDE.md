...
Full workflow: [Page Builder docs](../docs/docs/page-builder/introduction.md)
...
Full reference: [Strapi API Client docs](../docs/docs/ui/strapi-api-client.md)
...
Full reference: [Authentication docs](../docs/docs/auth/ui/authentication.md)

## Adding Page Builder Components

Use skill: `/create-content-component`, or do it manually

1. Create Strapi schema — see [apps/strapi/CLAUDE.md](../strapi/CLAUDE.md)
2. Generate types (see root CLAUDE.md)
3. Create component: `components/page-builder/components/{category}/Strapi{Name}.tsx`
4. Register in `PageContentComponents`

## Related Documentation

- [Page Builder](../docs/docs/page-builder/introduction.md) — Full component workflow
- [Strapi API Client](../docs/docs/ui/strapi-api-client.md) — Fetching content
- [Authentication](../docs/docs/auth/ui/authentication.md) — Better Auth + Strapi JWT
- [Strapi Types](../docs/docs/reference/packages/strapi-types.md) — Type utilities
