...
import { processLinkHrefAttribute } from "@/components/elementary/CkEditorRenderer/utils"
...
const CkEditorSSRRenderer = async ({
  ...
  return htmlContent ? (
    <div
      ...
      // biome-ignore lint/security/noDangerouslySetInnerHtml: Content is coming from Strapi, i.e. from employees, not users
